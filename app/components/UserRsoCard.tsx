import { DbRso, JoinRso, LeaveRso, State } from "./server/actions";
...
export default function UserRsoCard({ event, setIsLoading, handleStateChange } : RsoCardProps) {
  const handleSubmit = async () => {
    ...
    const res : State = await LeaveRso(rsoJoinData)
    setIsLoading(false);
